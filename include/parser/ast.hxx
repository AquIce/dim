...
_ClassName::_ClassName( \
  struct utils::Context ctx, \
	...
	NumberExpression(ctx, std::to_string(value)), \
	m_value(value) \
{} \
\
...
namespace dim {
	namespace parser {
		...
		class FunctionPrototypeExpression;
		class FunctionDeclarationExpression;
		class FunctionCallExpression;
		class InterfaceDeclarationExpression;
		...
		const std::array<std::string_view, 46> NodeTypeToStr = {
			"NONE",
			"NESTED",
			"SCOPE",
			"NUL",
...
namespace dim {
	namespace parser {
		...
		public:
			...
			class FunctionPrototypeExpression : public Expression {
			public:
			...
			class FunctionDeclarationExpression : public FunctionPrototypeExpression {
			public:
			...
			class InterfaceDeclarationExpression : public Expression {
			public:
				InterfaceDeclarationExpression(
					struct utils::Context ctx,
				...
				std::unordered_set<std::shared_ptr<FunctionPrototypeExpression>> GetMemberFunctionsPrototypes();
				std::expected<
					std::shared_ptr<FunctionPrototypeExpression>,
					std::string
				> GetMemberFunctionPrototype(
					const std::string& name
				);
			...
			private:
				...
				std::unordered_set<std::shared_ptr<FunctionPrototypeExpression>> m_memberFunctionsPrototypes;
				std::shared_ptr<IdentifierExpression> m_name;
			};
