...
namespace dim {
	namespace parser {
		...
		const auto ConversionTable = std::array<uint16_t, 16>({
			0b01111111111111111, // INFER
      		0b00000000000000010, // VOID
			0b00001110000111111, // I8
			0b00001110000111011, // I16
			0b00001110000110011, // I32
			0b00001110000100011, // I64
			0b00001111111111011, // U8
			0b00001111110110011, // U16
			0b00001111100100011, // U32
			0b00001111000000011, // U64
			0b00001110000000011, // F32
			0b00001100000000011, // F64
			0b00001000000000011, // F128
			0b00010000000000011, // BOOLEAN
			0b00100000000000011, // CHAR
			0b01000000000000011, // STRING
		});
